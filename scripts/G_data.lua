...
AUDIO = {
    ...
    sfx_kill   = "audio/sfx/sfx_kill_shout.ogg",
    sfx_skill  = "audio/sfx/sfx_skill_cast.ogg",
}
...
gameSettings = {
    ...
    -- 战斗精灵上限 (每方, 500~5000)
    spriteLimit = 1000,         -- 默认1000
    tbAutoBattle = false,       -- 回合制自动战斗开关
}
settingsPage = {
    ...
    draggingSpriteLimit = false, -- 是否正在拖拽精灵上限滑条
    musicSliderRect = nil,
    sfxSliderRect = nil,
    spriteLimitSliderRect = nil,
...
-- ============================================================================
DAILY_TASKS = {
    { id = "battle3",   name = "征伐三场",   desc = "完成3场战斗",       target = 3, reward = { jade = 450 } },
    { id = "win2",      name = "连胜两场",   desc = "赢得2场战斗",       target = 2, reward = { jade = 350 } },
    { id = "gacha5",    name = "五灵齐召",   desc = "完成5次召唤",       target = 5, reward = { jade = 280 } },
    { id = "equip1",    name = "装备兵甲",   desc = "装备1件兵甲",       target = 1, reward = { frag = 2 } },
    { id = "enhance1",  name = "强化兵甲",   desc = "强化1次装备",       target = 1, reward = { jade = 350 } },
    { id = "abyss1",    name = "讨伐挑战",   desc = "完成1次讨伐",       target = 1, reward = { jade = 550 } },
}
dailyTaskState = {
    lastResetDay = "",
    progress = {},
...
-- ============================================================================
WEEKLY_TASKS = {
    { id = "wbattle15",  name = "周伐十五",   desc = "本周完成15场战斗",    target = 15, reward = { jade = 2000 } },
    { id = "wwin10",     name = "十战十捷",   desc = "本周赢得10场",        target = 10, reward = { jade = 1600 } },
    { id = "wgacha20",   name = "二十灵召",   desc = "本周召唤20次",        target = 20, reward = { jade = 1350 } },
    { id = "wabyss3",    name = "讨伐周行",   desc = "本周完成3次讨伐",     target = 3,  reward = { jade = 2000 } },
    { id = "wenhance3",  name = "匠心三炼",   desc = "本周强化装备3次",     target = 3,  reward = { jade = 1350, frag = 3 } },
}
weeklyTaskState = {
    lastResetWeek = "",
    progress = {},
...
-- 英雄升级系统
-- ============================================================================
HERO_LEVEL_EXP = { 0, 25, 70, 130, 220, 350, 520, 720, 950, 1200 }
HERO_MAX_LEVEL = #HERO_LEVEL_EXP

-- ============================================================================
-- 装备强化/分解系统
-- ============================================================================
DECOMPOSE_LINGSHI = { 8, 15, 30, 60, 120, 200 }
-- 强化系统: +1~+15级, 每级+4%加成
ENHANCE_MAX_LEVEL = 15
ENHANCE_PERCENT_PER_LEVEL = 4  -- 每级+4%
-- 装备自身等级系统 (独立于强化)
EQUIP_LEVEL_MAX = 25           -- 装备最高等级
...
-- 首次达到1/2/3星的玉壁奖励
STAGE_STAR_JADE = { 50, 90, 140 }

-- 每页宝箱: 10/20/30星阈值
STAGE_CHEST_THRESHOLDS = { 10, 20, 30 }
STAGE_CHEST_REWARDS = {
    { jade = 350, frag = 6 },    -- 10星宝箱
    { jade = 700, frag = 12 },   -- 20星宝箱
    { jade = 1300, frag = 25 },  -- 30星宝箱
}
...
SKILL_MAX_REFUND_JADE = 50  -- 满层武技再合成返还玉壁
...
HERO_FULL_CARD_RATE = 4   -- 整卡出率: 4% (极小概率)

-- 限定池配置
LIMITED_GACHA_COST = 250        -- 限定池单抽费用
LIMITED_GACHA_TEN_COST = 2200   -- 限定池十连费用
...
-- 武灵兵符系统 (全局)
-- ============================================================================
--- 六德孔位名称 (仁义礼智信勇 → 武力/智力/体力/技法/速度/暴击)
SEAL_SLOT_NAMES = { "仁符", "义符", "礼符", "智符", "信符", "勇符" }
SEAL_MAX_SLOTS = 6        -- 每个武灵最多6孔
SEAL_MAX_LEVEL = 8        -- 每个兵符最高8级
SEAL_GACHA_COST = 250     -- 兵符单抽费用
SEAL_GACHA_TEN_COST = 2200 -- 兵符十连费用 (约8.8折)
SEAL_DUPE_REFUND = 70     -- 重复兵符返还玉壁
...
--- 六德兵符效果系统 (五维属性 + 暴击)
--- 孔位1~5各对应一个五维属性, 孔位6对应暴击率
--- 五维数值为直接加点(叠加到 stats5 上, 范围1~100), 暴击率为百分比
SEAL_SLOT_EFFECTS = {
    [1] = { -- 仁: 武力
        theme = "武力强化", desc = "提升武力(ATK加成)",
        mainKey = "strAdd", mainName = "武力",
        [1] = { main = 1 },   -- 凡品
        [2] = { main = 2 },   -- 良品
        [3] = { main = 3 },   -- 优品
        [4] = { main = 5 },   -- 将品
    ...
    [2] = { -- 义: 智力
        theme = "智力强化", desc = "提升智力(技能伤害加成)",
        mainKey = "intAdd", mainName = "智力",
        [1] = { main = 1 },
        [2] = { main = 2 },
        [3] = { main = 3 },
        [4] = { main = 5 },
    ...
    [3] = { -- 礼: 体力
        theme = "体力强化", desc = "提升体力(HP加成)",
        mainKey = "vitAdd", mainName = "体力",
        [1] = { main = 1 },
        [2] = { main = 2 },
        [3] = { main = 3 },
        [4] = { main = 5 },
    ...
    [4] = { -- 智: 技法
        theme = "技法强化", desc = "提升技法(暴击率加成)",
        mainKey = "tecAdd", mainName = "技法",
        [1] = { main = 1 },
        [2] = { main = 2 },
        [3] = { main = 3 },
        [4] = { main = 5 },
    ...
    [5] = { -- 信: 速度
        theme = "速度强化", desc = "提升速度(移速+攻速加成)",
        mainKey = "spdAdd", mainName = "速度",
        [1] = { main = 1 },
        [2] = { main = 2 },
        [3] = { main = 3 },
        [4] = { main = 5 },
    ...
    [6] = { -- 勇: 暴击
        theme = "暴击强化", desc = "提升暴击率(%)",
        mainKey = "critRate", mainName = "暴击率",
        [1] = { main = 0.5 },
        [2] = { main = 1.0 },
        [3] = { main = 1.5 },
        [4] = { main = 2.5 },
...
--- 六德孔位主题色 (每个德位的标志色, 在UI中区分)
SEAL_SLOT_THEME_COLORS = {
    [1] = { 255, 140, 100 },  -- 仁(武力): 暖橙红
    [2] = { 120, 180, 255 },  -- 义(智力): 天蓝
    [3] = { 100, 220, 130 },  -- 礼(体力): 翠绿
    [4] = { 255, 210, 80 },   -- 智(技法): 金黄
    [5] = { 100, 220, 200 },  -- 信(速度): 青色
    [6] = { 255, 80, 80 },    -- 勇(暴击): 亮红
}
...
--- 召唤系统页签状态 (SUMMON phase)
summonTab = 1             -- 1=兵符召唤, 2=武将召唤
summonTabRects = {}       -- 页签按钮区域
summonBackBtnRect = nil   -- 返回按钮区域

--- 武将召唤状态
heroGachaState = {
    results = {},        -- 本次抽卡结果 { {cardIdx, name, quality, fragCount, isFullCard, isNew, oldConst, newConst} ... }
    showResults = false,
    pulling = false,
    pullTimer = 0,
    pullCount = 0,
    showRules = false,   -- 概率规则弹窗
    pityCounter = 0,     -- 大保底计数器 (距离上次整卡的抽数)
}

--- 武将召唤碎片奖励配置 (每次抽到该品质给多少碎片)
HERO_GACHA_FRAG_REWARD = {
    [1] = { min = 3, max = 5 },   -- N  品质: 3~5碎片
    [2] = { min = 2, max = 4 },   -- R  品质: 2~4碎片
    [3] = { min = 1, max = 3 },   -- SR 品质: 1~3碎片
    [4] = { min = 1, max = 2 },   -- SSR品质: 1~2碎片
    [5] = { min = 1, max = 1 },   -- 限定SSR: 1碎片
}

--- 大保底抽数阈值 (每X抽必出一张整卡)
HERO_GACHA_PITY_THRESHOLD = 70
heroGachaSingleBtnRect = nil
heroGachaTenBtnRect = nil
heroGachaConfirmBtnRect = nil
heroGachaRulesBtnRect = nil
heroGachaRulesCloseBtnRect = nil
heroGachaHundredBtnRect = nil  -- 百连按钮 (仅增强模式)
heroGachaCodexBtnRect = nil    -- 武将录入口按钮
...
--- 武技召唤状态
skillGachaState = {
    results = {},        -- 本次抽卡结果 { {skillIdx, name, tier, isFullCard, fragCount, isNew, oldLayer, newLayer} ... }
    showResults = false,
    pulling = false,
    pullTimer = 0,
    pullCount = 0,
...
--- 武技召唤碎片奖励配置 (每次抽到该品级给多少碎片)
SKILL_GACHA_FRAG_REWARD = {
    [1] = { min = 3, max = 5 },   -- 凡品: 3~5碎片
    [2] = { min = 2, max = 4 },   -- 良品: 2~4碎片
    [3] = { min = 1, max = 3 },   -- 优品: 1~3碎片
    [4] = { min = 1, max = 2 },   -- 将品: 1~2碎片
    [5] = { min = 1, max = 2 },   -- 侯品: 1~2碎片
    [6] = { min = 1, max = 1 },   -- 王品: 1碎片
    [7] = { min = 1, max = 1 },   -- 帝品: 1碎片
}

--- 武技大保底抽数阈值
SKILL_GACHA_PITY_THRESHOLD = 70

--- 武技召唤按钮区域
skillGachaSingleBtnRect = nil
skillGachaTenBtnRect = nil
skillGachaHundredBtnRect = nil
skillGachaConfirmBtnRect = nil
skillGachaRulesBtnRect = nil
skillGachaRulesCloseBtnRect = nil
