...
WEEKLY_RANK_REWARDS = {
    ...
    },
    {
        ...
        tiers = {
            { maxRank = 1,  rewards = { { type = "jade", amount = 400, label = "玉壁 ×400" } } },
            { maxRank = 3,  rewards = { { type = "jade", amount = 200, label = "玉壁 ×200" } } },
            { maxRank = 10, rewards = { { type = "jade", amount = 100, label = "玉壁 ×100" } } },
        },
    },
    {
...
-- 每侧最多4个槽位 — 新布局: 玩家在左侧纵列(x=60), 敌方在右侧纵列(x=964)
PLAYER_SLOTS = {
    MakeHeroSlot(60, 80),
    MakeHeroSlot(60, 220),
    MakeHeroSlot(60, 360),
...
ENEMY_SLOTS = {
    MakeHeroSlot(964, 80),
    MakeHeroSlot(964, 220),
    MakeHeroSlot(964, 360),
...
HERO_CARDS = {
    ...
    { name = "刘巴", row = 0, col = 0, type = CARD_TYPE.BUFF, quality = QUALITY.COMMON, singleImg = "hero50",
      ...
      skillData = { cd = 12, kind = "buff", atkBuff = 0.08, defBuff = 0.08, duration = 8, goldBonus = 3, desc = "理财安国，攻防各+8%持续8秒，额外获得3军资" } },
    -- 51. 费祎 — 蜀汉丞相
    ...
    { name = "刘璋", row = 0, col = 0, type = CARD_TYPE.HEAL, quality = QUALITY.EPIC, singleImg = "hero91",
      ...
      skillData = { cd = 12, kind = "heal", healMult = 0.22, goldBonus = 3, desc = "益州富庶补给全军，恢复22%生命，获得3军资" } },
    -- 92. 张鲁 — 天师道主
...
TROOP_COUNTER = {
    -- 循环克制: 步兵>弓兵>骑兵>枪兵>步兵
    infantry = { infantry = 1.0, archer = 1.3, cavalry = 1.0, spear = 0.7 },
    archer   = { infantry = 0.7, archer = 1.0, cavalry = 1.3, spear = 1.0 },
    cavalry  = { infantry = 1.0, archer = 0.7, cavalry = 1.0, spear = 1.3 },
    spear    = { infantry = 1.3, archer = 1.0, cavalry = 0.7, spear = 1.0 },
}
...
FORMATIONS = {
    { id="fish_scale", name="鱼鳞阵", desc="密集推进，利于正面强攻",   suitFor="步兵/枪兵",
      spawnCdMult=0.85, laneWeights={1,2,3,2,1},
      playerAtkMult=1.10, playerDefMult=1.00, archerAtkBonus=0,    counterDmgReflect=0,
      troopZones = {
    ...
    { id="crane_wing", name="鹤翼阵", desc="两翼包夹，弓弩占位优",     suitFor="弓兵/骑兵",
      spawnCdMult=1.05, laneWeights={2,1,1,1,2},
      playerAtkMult=1.00, playerDefMult=1.00, archerAtkBonus=0.20, counterDmgReflect=0,
      troopZones = {
    ...
    { id="arrowhead",  name="锋矢阵", desc="中路突破，骑兵冲锋最佳",   suitFor="骑兵/步兵",
      spawnCdMult=0.80, laneWeights={1,1,4,1,1},
      playerAtkMult=1.15, playerDefMult=0.90, archerAtkBonus=0,    counterDmgReflect=0,
      troopZones = {
    ...
    { id="square",     name="方圆阵", desc="全面防守，减少克制损失",     suitFor="步兵/枪兵",
      spawnCdMult=1.10, laneWeights={1,2,2,2,1},
      playerAtkMult=0.95, playerDefMult=1.20, archerAtkBonus=0,    counterDmgReflect=0.30,
      troopZones = {
    ...
    { id="wild_goose", name="雁行阵", desc="阶梯交错，克制加成最高",   suitFor="混编",
      ...
      playerAtkMult=1.05, playerDefMult=1.05, archerAtkBonus=0.10, counterDmgReflect=0.15,
      troopZones = {
...
EQUIPMENT_SETS = {
    { -- Set 1 (col 0): 虎牢关套 — 防御型 | 额外词条: 减伤
        ...
        pieces = {
            { name = "长关长矛", atkPct = 1, defPct = 4, hpPct = 3 },
    ...
    { -- Set 4 (col 3): 龙胆剑士套 — 剑系特化 | 额外词条: 反击
        ...
        pieces = {
            ...
            { name = "疾风腿甲", atkPct = 3, defPct = 1, hpPct = 1 },
            { name = "微光腿甲", atkPct = 3, defPct = 1, hpPct = 1 },
    ...
    { -- Set 6 (col 5): 霸王神威套 — 重攻击 | 额外词条: 死亡爆炸
        ...
        pieces = {
            ...
            { name = "玉壁令",     atkPct = 3, defPct = 1, hpPct = 2 },
    ...
    { -- Set 7 (col 6): 行伍新兵套 — 均衡/新手 | 额外词条: 移速
        ...
        pieces = {
            ...
            { name = "不灭兵书", atkPct = 1, defPct = 2, hpPct = 2 },
            { name = "新兵木剑", atkPct = 2, defPct = 2, hpPct = 2 },
            { name = "粗布腿裤", atkPct = 1, defPct = 2, hpPct = 2 },
            { name = "霸王兵书", atkPct = 2, defPct = 1, hpPct = 2 },
...
-- 每侧最多4个武将槽位，均匀分布在4条车道 (BG像素坐标: 100/550 对应设计坐标 ~143/789)
local _defaultPlayerSlots = {{100,233},{100,430},{100,628},{100,825}}
local _defaultEnemySlots  = {{550,233},{550,430},{550,628},{550,825}}
...
gameState = {
    ...
    totalKills = 0,
    gameTime = 0,
    phase = "LOADING",      -- LOADING / PROFILE / MENU / GACHA / CODEX / EQUIP / EQUIP_CODEX / STAGE_SELECT / ABYSS_SELECT / EXPLORATION / TOWER_SELECT / RANKED_SELECT / BATTLE / WIN / LOSE / WELFARE / PROGRESS / PLAYER_DETAIL / SKILL_CODEX / SKILL_DETAIL / DEV_EDITOR
